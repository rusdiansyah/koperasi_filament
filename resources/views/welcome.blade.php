            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        <a href="http://filament_koperasi.test/admin/login"
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Panel Admin</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Halaman untuk mengelola Penguna, Anggota, Simpanan dan Pinjaman Anggota.
                                    Laporan yang dibutuhkan oleh pengurus Koperasi. <br>
                                    Akun Demo pengurus@koperasi.com sandi 123123123
                                </p>
                            </div>
                        ...
                        <a href="http://filament_koperasi.test/anggota/login"
                            class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                            <div
                                class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                <svg class="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Panel Anggota</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    Halaman untuk Anggota agar bisa melihat biodata, simpanan dan pinjaman. <br>
                                    Akun Demo anggota@koperasi.com sandi 123123123
                                </p>
                            </div>
                        ...
                        <div
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Deddy Rusdiansyah,M.Kom</h2>

                                <p class="mt-4 text-sm/relaxed">
                                    <ol>
                                        <li><a href="https://deddyrusdiansyah.blogspot.com">Blog</a></li>
                                        <li><a href="https://deddydev.com">Website</a></li>
                                    </ol>
                                </p>
                            </div>
                        </div>
